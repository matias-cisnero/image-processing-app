...
\begin{frame}[fragile]{Resultados}
	...
	\begin{minipage}{0.45\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_original}
		\captionof{figure}{Imagen original}
		\label{fig:lenaoriginal1}
	\end{minipage}\hfill
	\begin{minipage}{0.45\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_ej1}
...
\begin{frame}[fragile]{Resultados}
	...
	\begin{minipage}{0.45\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_ej2}
...
\begin{frame}[fragile]{Resultados}
	...
	\begin{minipage}{0.45\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_hist_gris}
...
\begin{frame}[fragile]{Resultados}
	...
	\begin{minipage}{0.45\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_ej4}
...
\begin{frame}[fragile]{Resultados histogramas}
	...
	\begin{minipage}{0.45\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_hist_gris_ecualizado}
...
\begin{frame}[fragile]{Resultados imagen}
	...
	\begin{minipage}{0.45\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_ej5}
...
\begin{frame}[fragile]{Resultados - Histogramas}
	...
	\begin{minipage}{0.32\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_hist_gris_ecualizado2}
...
\begin{frame}[fragile]{Resultados - Imágenes}
	...
	\begin{minipage}{0.32\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_ej6}
		\captionof{figure}{2ª ecualización}
		\label{fig:lenaej6b}
	\end{minipage}
\end{frame}
...
\begin{frame}[fragile]{Resultados}
	...
	\begin{minipage}{0.32\linewidth}
		\centering
		\includegraphics[width=\linewidth]{dist_gauss}
		\captionof{figure}{Dist gaussiana}
	\end{minipage}\hfill
	% Segunda imagen
	\begin{minipage}{0.32\linewidth}
		\centering
		\includegraphics[width=\linewidth]{dist_rayleigh}
		\captionof{figure}{Dist rayleigh}
	\end{minipage}\hfill
	% Tercera imagen
	\begin{minipage}{0.32\linewidth}
		\centering
		\includegraphics[width=\linewidth]{dist_exponencial}
...
\begin{frame}[fragile]{Resultados}
	...
	\begin{minipage}{0.45\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_ej8a}
...
\begin{frame}[fragile]{Resultados}
	...
	\begin{minipage}{0.45\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_ej8b}
		\captionof{figure}{Imagen con ruido}
		\label{fig:lenaej8b}
	\end{minipage}
\end{frame}
...
\begin{frame}[fragile]{Resultados}
	...
	\begin{minipage}{0.45\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_ej8c}
		\captionof{figure}{Imagen con ruido}
		\label{fig:lenaej8c}
	\end{minipage}
\end{frame}
...
\begin{frame}[fragile]{Resultados}
	...
	\begin{minipage}{0.45\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_ej9}
		\captionof{figure}{Imagen con ruido}
		\label{fig:lenaej9}
	\end{minipage}
\end{frame}
...
\begin{frame}[fragile]{Resultados - Filtro Media}
	...
	\begin{minipage}{0.45\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_ej10a}
...
\begin{frame}[fragile]{Resultados - Filtro Mediana}
	...
	\begin{minipage}{0.45\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_ej10b}
...
\begin{frame}[fragile]{Resultados - Filtro Mediana Ponderada}
	...
	\begin{minipage}{0.45\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_ej10c}
...
\begin{frame}[fragile]{Resultados - Filtro Gaussiano}
	...
	\begin{minipage}{0.32\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_ej10d1}
	...
	\begin{minipage}{0.32\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_ej10d2}
...
\begin{frame}[fragile]{Resultados - Filtro Realce de Bordes}
	...
	\begin{minipage}{0.45\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_ej10e}
...
\begin{frame}[fragile]{Filtro Media sobre Ruido Gaussiano}
	...
	\begin{minipage}{0.25\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_gauss_sigma10}
	\end{minipage}\hfill
	\begin{minipage}{0.25\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_gauss_sigma20}
	\end{minipage}\hfill
	\begin{minipage}{0.25\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_gauss_sigma50}
	\end{minipage}
	
	% Segunda fila: imágenes filtradas
	\begin{minipage}{0.25\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_gauss_sigma10_media}
	\end{minipage}\hfill
	\begin{minipage}{0.25\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_gauss_sigma20_media}
	\end{minipage}\hfill
	\begin{minipage}{0.25\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_gauss_sigma50_media}
	\end{minipage}
\end{frame}
...
\begin{frame}[fragile]{Filtro Mediana sobre Ruido Gaussiano}
	...
	\begin{minipage}{0.25\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_gauss_sigma10_mediana}
	\end{minipage}\hfill
	\begin{minipage}{0.25\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_gauss_sigma20_mediana}
	\end{minipage}\hfill
	\begin{minipage}{0.25\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_gauss_sigma50_mediana}
	\end{minipage}
\end{frame}
...
\begin{frame}[fragile]{Filtro Mediana Ponderada sobre Ruido Gaussiano}
	...
	\begin{minipage}{0.25\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_gauss_sigma10_mediana_ponderada}
	\end{minipage}\hfill
	\begin{minipage}{0.25\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_gauss_sigma20_mediana_ponderada}
	\end{minipage}\hfill
	\begin{minipage}{0.25\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_gauss_sigma50_mediana_ponderada}
	\end{minipage}
\end{frame}
...
\begin{frame}[fragile]{Filtro Gaussiano sobre Ruido Gaussiano}
	...
	\begin{minipage}{0.25\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_gauss_sigma10_gaussiano}
	\end{minipage}\hfill
	\begin{minipage}{0.25\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_gauss_sigma20_gaussiano}
	\end{minipage}\hfill
	\begin{minipage}{0.25\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_gauss_sigma50_gaussiano}
	\end{minipage}
\end{frame}
...
\begin{frame}[fragile]{Filtro Realce de Bordes sobre Ruido Gaussiano}
	...
	\begin{minipage}{0.25\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_gauss_sigma10_bordes}
	\end{minipage}\hfill
	\begin{minipage}{0.25\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_gauss_sigma20_bordes}
	\end{minipage}\hfill
	\begin{minipage}{0.25\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_gauss_sigma50_bordes}
	\end{minipage}
\end{frame}
...
\begin{frame}[fragile]{Filtro Media sobre Ruido Rayleigh}
	...
	\begin{minipage}{0.25\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_rayleigh_xi1}
	\end{minipage}\hfill
	\begin{minipage}{0.25\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_rayleigh_xi2}
	\end{minipage}\hfill
	\begin{minipage}{0.25\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_rayleigh_xi10}
	\end{minipage}
	
	% Segunda fila: imágenes filtradas
	\begin{minipage}{0.25\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_rayleigh_xi1_media}
	\end{minipage}\hfill
	\begin{minipage}{0.25\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_rayleigh_xi2_media}
	\end{minipage}\hfill
	\begin{minipage}{0.25\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_rayleigh_xi10_media}
	\end{minipage}
\end{frame}
...
\begin{frame}[fragile]{Filtro Mediana sobre Ruido Rayleigh}
	...
	\begin{minipage}{0.25\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_rayleigh_xi1_mediana}
	\end{minipage}\hfill
	\begin{minipage}{0.25\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_rayleigh_xi2_mediana}
	\end{minipage}\hfill
	\begin{minipage}{0.25\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_rayleigh_xi10_mediana}
	\end{minipage}
\end{frame}
...
\begin{frame}[fragile]{Filtro Mediana Ponderada sobre Ruido Rayleigh}
	...
	\begin{minipage}{0.25\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_rayleigh_xi1_mediana_ponderada}
	\end{minipage}\hfill
	\begin{minipage}{0.25\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_rayleigh_xi2_mediana_ponderada}
	\end{minipage}\hfill
	\begin{minipage}{0.25\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_rayleigh_xi10_mediana_ponderada}
	\end{minipage}
\end{frame}
...
\begin{frame}[fragile]{Filtro Gaussiano sobre Ruido Rayleigh}
	...
	\begin{minipage}{0.25\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_rayleigh_xi1_gaussiano}
	\end{minipage}\hfill
	\begin{minipage}{0.25\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_rayleigh_xi2_gaussiano}
	\end{minipage}\hfill
	\begin{minipage}{0.25\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_rayleigh_xi10_gaussiano}
	\end{minipage}
\end{frame}
...
\begin{frame}[fragile]{Filtro Realce de Bordes sobre Ruido Rayleigh}
	...
	\begin{minipage}{0.25\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_rayleigh_xi1_bordes}
	\end{minipage}\hfill
	\begin{minipage}{0.25\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_rayleigh_xi2_bordes}
	\end{minipage}\hfill
	\begin{minipage}{0.25\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_rayleigh_xi10_bordes}
	\end{minipage}
\end{frame}
...
\begin{frame}[fragile]{Resultados - Filtros sobre ruido Sal y Pimienta (a)}
	...
	\begin{minipage}{0.32\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_ej12a}
		\captionof{figure}{Imagen con ruido}
		\label{fig:lenaej12a}
	\end{minipage}\hfill
	% Filtro Media
	\begin{minipage}{0.32\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_ej12a1}
	...
	\begin{minipage}{0.32\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_ej12a2}
...
\begin{frame}[fragile]{Resultados - Filtros sobre ruido Sal y Pimienta (b)}
	...
	\begin{minipage}{0.32\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_ej12b}
		\captionof{figure}{Imagen con ruido}
		\label{fig:lenaej12b}
	\end{minipage}\hfill
	% Filtro Media
	\begin{minipage}{0.32\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_ej12b1}
		\captionof{figure}{Filtro Media}
	...
	\begin{minipage}{0.32\linewidth}
		\centering
		\includegraphics[width=\linewidth]{lena_ej12b2}
		\captionof{figure}{Filtro Mediana}
